...
const installString = `npm i @classmatejs/react
# or
yarn add @classmatejs/react
# or
pnpm add @classmatejs/react
`
  ...
  return (
    <>
      <DocsHead
        ...
        pre="Working with @classmatejs/react"
        excerpt="Learn how to install and get started with @classmatejs/react"
      />
      ...
      <Section>
        ...
        <HighlighterComponent language="bash" input='import cm from "@classmatejs/react"' />
        <SectionInnerHeadline>Import with CommonJS</SectionInnerHeadline>
        <HighlighterComponent language="bash" input='const cm = require("@classmatejs/react").default' />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Section>
            <ul>
              <li>
                <LinkComponent href="https://www.npmjs.com/package/@classmatejs/react">npm</LinkComponent>
              </li>
              <li>
