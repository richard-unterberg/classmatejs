    ...
    <>
      ...
      <Section>
        <SectionInnerParagraph>
          ...
          @classmatejs/react. It supports rendering standard HTML heading tags (h1 to h6) as well as other
      ...
      <Section>
        <SectionInnerParagraph>
          ...
          preset) alongside @classmatejs/react. We'll walk through all the important bits after this section
        </SectionInnerParagraph>
      ...
      <Section>
        ...
        <SectionInnerParagraph>
          ...
          <CodeElement>VariantsConfig</CodeElement> type from <CodeElement>@classmatejs/react</CodeElement>.
